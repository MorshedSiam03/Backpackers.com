...
const Register = () => {
    ...
    return (
        <>
        <div className="hero">
        <div className="hero-content w-[90%] md:w-[60%] lg:w-[40%]">
          <div className="card shrink-0 w-full shadow-2xl bg-base-100">
            ...
            <form onSubmit={handleRegister} className="card-body">
              ...
              <div>
                 <input type="checkbox" name="checkbox" id="" /> <label>Accept our <span className="underline">Terms & Conditions</span></label>
              </div>
              {
